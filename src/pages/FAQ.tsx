...
const FAQS = [
  ...
  },
  {
    ...
    a: "Supenli.ai supports content generation in English and French. The dashboard interface is in French, while the landing page is in English. We're planning to add more languages (Spanish, Portuguese, German) based on user demand.",
  },
  {
  ...
  },
  {
    ...
    a: "Yes! After generating your content, Supenli.ai offers an infographic creator powered by Google Gemini. Choose a visual style (Sketchnote, Modern, or Colorful), and we generate a 1080x1080 PNG image ready for Instagram, LinkedIn, or any platform. You can also get image prompt suggestions for tools like Midjourney or DALL-E.",
  },
];
  ...
  return (
    <div className="min-h-screen bg-background text-foreground">
      ...
      <main className="max-w-3xl mx-auto px-6 py-20">
        ...
        <p className="text-sm text-muted-foreground mb-12">Everything you need to know about Supenli.ai</p>
