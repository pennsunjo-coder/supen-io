      ...
      <main className="max-w-3xl mx-auto px-6 py-20">
        ...
        <div className="space-y-10 text-sm text-muted-foreground leading-relaxed">
          <section>
            ...
            <p>
              By accessing or using Supen.io, you agree to be bound by these Terms of Service.
          ...
          <section>
            ...
            <p>
              Supen.io is an AI-powered content creation platform that helps creators generate
          ...
          <section>
            ...
            <ul className="list-disc list-inside space-y-1.5 ml-2">
              ...
              <li>You must be at least 16 years old to use Supen.io.</li>
          ...
          <section>
            ...
            <p className="mb-3">You agree not to use Supen.io to:</p>
            <ul className="list-disc list-inside space-y-1.5 ml-2">
            ...
            <p className="mt-4 font-medium text-foreground">
              You are solely responsible for the content you generate and publish using Supen.io.
            </p>
          </section>
          ...
          <section>
            ...
            <ul className="list-disc list-inside space-y-1.5 ml-2">
              <li><strong className="text-foreground">Your content</strong> — You retain full ownership of all content you generate using Supen.io. We claim no rights over your generated posts, infographics, or other outputs.</li>
              <li><strong className="text-foreground">Our platform</strong> — Supen.io, including its design, code, AI models integration, and branding, is owned by Supen.io and protected by intellectual property laws.</li>
          ...
          <section>
            ...
            <p>
              Supen.io is provided "as is" without warranties of any kind. To the maximum extent
          ...
          <section>
            ...
            <p>
              ...
              <a href="mailto:legal@supen.io" className="text-primary hover:underline">legal@supen.io</a>.
            </p>
          </section>
        </div>
      </main>
